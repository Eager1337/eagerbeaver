...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "EAGER-HUB" },
      { name: "description", content: "TOONHUB figurines carousel" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "EAGER-HUB" },
      { property: "og:description", content: "TOONHUB figurines carousel" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "EAGER-HUB" },
      { name: "twitter:description", content: "TOONHUB figurines carousel" },
