      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 py-10">
        ...
        <div className="mt-14 grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            {l.body && (
              <p className="mt-6 max-w-xl whitespace-pre-line text-sm leading-relaxed text-white/70">
                {l.body}
              </p>
            )}
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link
                to="/explore"
                className="inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/5 px-6 py-3 text-sm font-semibold hover:bg-white/10"
              >
          ...
          >
            {l.image ? (
              ...
              <div
                className="grid h-full w-full place-items-center text-white/70"
                style={{ fontFamily: "'Kanit', sans-serif" }}
              >
